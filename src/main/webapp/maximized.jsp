...
<head>
    ...
    <%--<script language='javascript' src='/static/layui/layui.js'  type="text/javascript" ></script>--%>
...
<a href="/BizApex/"><h4>Hello Link</h4></a>
<a href="">打开链接</a>
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button class="layui-btn layui-btn-primary"  type="button" id="log_button">日志</button>
        </div>
    </div>
</form>

<!-- 示例-970 -->
<ins class="adsbygoogle" style="width: 970px; height: 90px; display: inline-block;" data-ad-slot="3820120620" data-ad-client="ca-pub-6111334333458862"></ins>
...
<form class="layui-form" action="" lay-filter="example">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="desc" class="layui-textarea" placeholder="请输入内容">请输入内容</textarea>
        </div>
    </div>
...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item" pane="">
        ...
        <div class="layui-input-block">
            <input name="open" title="开关" type="checkbox" checked="" lay-skin="switch" lay-filter="switchTest">
        </div>
    </div>
    <div class="layui-form-item" pane="">
        <label class="layui-form-label">单选框</label>
...
<script>
    layui.use(['form', 'layedit', 'laydate','layer','jquery'], function(){
        ...
        layui.$('#log_button').on('click', function(){
            $.ajax({
                type: "post",
